...
set portList { 
	...
	{ empty_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ inStream_in_length_dout sc_in sc_lv 16 signal 1 } 
	{ inStream_in_length_empty_n sc_in sc_logic 1 signal 1 } 
	{ inStream_in_length_read sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	empty { ap_vld {  { empty out_data 1 16 }  { empty_ap_vld out_vld 1 1 } } }
