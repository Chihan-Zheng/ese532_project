set moduleName Loop_VITIS_LOOP_318_1_proc
set isTopModule 0
...
set C_modelName {Loop_VITIS_LOOP_318_1_proc}
set C_modelType { int 8 }
set C_modelArgList {
	{ input_length_temp int 16 regular {array 4 { 0 3 } 0 1 }  }
	{ input_length int 64 regular {fifo 0}  }
	{ aximm1 int 16 regular {axi_master 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_length_temp", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "input_length", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ input_length_temp_address0 sc_out sc_lv 2 signal 0 } 
	{ input_length_temp_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_length_temp_we0 sc_out sc_logic 1 signal 0 } 
	{ input_length_temp_d0 sc_out sc_lv 16 signal 0 } 
	{ input_length_dout sc_in sc_lv 64 signal 1 } 
	{ input_length_empty_n sc_in sc_logic 1 signal 1 } 
	{ input_length_read sc_out sc_logic 1 signal 1 } 
	...
	{ m_axi_aximm1_AWLEN sc_out sc_lv 32 signal 2 } 
	...
	{ m_axi_aximm1_WDATA sc_out sc_lv 16 signal 2 } 
	{ m_axi_aximm1_WSTRB sc_out sc_lv 2 signal 2 } 
	...
	{ m_axi_aximm1_ARLEN sc_out sc_lv 32 signal 2 } 
	...
	{ m_axi_aximm1_RDATA sc_in sc_lv 16 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_length_temp_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_length_temp", "role": "we0" }} , 
 	{ "name": "input_length_temp_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "input_length_temp", "role": "d0" }} , 
 	{ "name": "input_length_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "input_length", "role": "dout" }} , 
 	{ "name": "input_length_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_length", "role": "empty_n" }} , 
 	{ "name": "input_length_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_length", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "input_length_temp", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "input_length", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	input_length_temp { ap_memory {  { input_length_temp_address0 mem_address 1 2 }  { input_length_temp_ce0 mem_ce 1 1 }  { input_length_temp_we0 mem_we 1 1 }  { input_length_temp_d0 mem_din 1 16 } } }
	input_length { ap_fifo {  { input_length_dout fifo_data 0 64 }  { input_length_empty_n fifo_status 0 1 }  { input_length_read fifo_update 1 1 } } }
