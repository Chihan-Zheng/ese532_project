...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name input_length_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_input_length_out \
    op interface \
    ports { input_length_out_din { O 64 vector } input_length_out_full_n { I 1 bit } input_length_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_send_data_out1 \
    op interface \
    ports { send_data_out1_din { O 64 vector } send_data_out1_full_n { I 1 bit } send_data_out1_write { O 1 bit } } \
} "
}
