...
set C_modelArgList {
	{ aximm0 int 64 regular {axi_master 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "aximm0", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ input_offset_constprop_i sc_in sc_lv 32 signal 3 } 
	{ input_offset_constprop_o sc_out sc_lv 32 signal 3 } 
	{ input_offset_constprop_o_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "65608"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "65608"}
]}
...
set Spec2ImplPortList { 
	...
	input_offset_constprop { ap_ovld {  { input_offset_constprop_i in_data 0 32 }  { input_offset_constprop_o out_data 1 32 }  { input_offset_constprop_o_ap_vld out_vld 1 1 } } }
