...
entity krnl_LZW_krnl_LZW_entry4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_LZW_krnl_LZW_entry4 is 
...
begin
    ...
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ...
            input_length_out_blk_n <= ap_const_logic_1;
        end if; 
    end process;
    ...
    send_data_out1_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, send_data_out1_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            send_data_out1_blk_n <= send_data_out1_full_n;
        else 
            send_data_out1_blk_n <= ap_const_logic_1;
        end if; 
    end process;
