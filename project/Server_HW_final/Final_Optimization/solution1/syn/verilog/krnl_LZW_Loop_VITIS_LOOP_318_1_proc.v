...
module krnl_LZW_Loop_VITIS_LOOP_318_1_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        input_length_temp_we0,
        input_length_temp_d0,
        input_length_dout,
...
output   input_length_temp_we0;
output  [15:0] input_length_temp_d0;
input  [63:0] input_length_dout;
...
reg   [2:0] i_reg_105;
reg   [2:0] i_reg_105_pp0_iter1_reg;
wire    ap_block_state72_pp0_stage0_iter0;
reg    ap_block_state73_pp0_stage0_iter1;
wire    ap_block_state74_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
reg   [63:0] aximm1_addr_reg_185;
wire   [2:0] add_ln318_fu_145_p2;
reg   [2:0] add_ln318_reg_191;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] icmp_ln318_fu_151_p2;
reg   [0:0] icmp_ln318_reg_196;
reg   [15:0] aximm1_addr_read_reg_200;
wire    ap_CS_fsm_state71;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state72;
reg    ap_enable_reg_pp0_iter2;
reg   [2:0] ap_phi_mux_i_phi_fu_109_p4;
wire   [63:0] i_cast_i_fu_157_p1;
wire   [0:0] icmp_ln319_fu_162_p2;
wire  signed [63:0] sext_ln319_fu_130_p1;
reg   [7:0] num_chunks_fu_70;
wire   [7:0] num_chunks_1_fu_167_p2;
reg    ap_block_state1;
wire    ap_CS_fsm_state75;
wire   [62:0] trunc_ln319_1_fu_120_p4;
reg   [72:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        i_reg_105 <= 3'd0;
    end else if (((icmp_ln318_reg_196 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        i_reg_105 <= add_ln318_reg_191;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (input_length_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        num_chunks_fu_70 <= 8'd0;
    end else if (((icmp_ln319_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln318_fu_151_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln318_reg_196 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln319_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        input_length_temp_we0 = 1'b1;
    end else begin
        input_length_temp_we0 = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln318_fu_151_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((icmp_ln318_fu_151_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln318_fu_145_p2 = (ap_phi_mux_i_phi_fu_109_p4 + 3'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (input_length_empty_n == 1'b0));
end

assign ap_block_state72_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = (m_axi_aximm1_RVALID == 1'b0);
end
...
assign ap_return = num_chunks_fu_70;

assign i_cast_i_fu_157_p1 = i_reg_105_pp0_iter1_reg;

assign icmp_ln318_fu_151_p2 = ((ap_phi_mux_i_phi_fu_109_p4 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln319_fu_162_p2 = ((aximm1_addr_read_reg_200 == 16'd0) ? 1'b1 : 1'b0);

assign input_length_temp_address0 = i_cast_i_fu_157_p1;

assign input_length_temp_d0 = aximm1_addr_read_reg_200;

assign m_axi_aximm1_ARADDR = aximm1_addr_reg_185;
...
assign m_axi_aximm1_ARLEN = 32'd4;
...
assign num_chunks_1_fu_167_p2 = (num_chunks_fu_70 + 8'd1);

assign sext_ln319_fu_130_p1 = $signed(trunc_ln319_1_fu_120_p4);

assign trunc_ln319_1_fu_120_p4 = {{input_length_dout[63:1]}};

endmodule //krnl_LZW_Loop_VITIS_LOOP_318_1_proc
