...
entity krnl_LZW_Loop_VITIS_LOOP_318_1_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_LZW_Loop_VITIS_LOOP_318_1_proc is 
...
attribute shreg_extract : string;
    ...
    signal input_length_blk_n : STD_LOGIC;
    ...
    signal i_reg_105_pp0_iter1_reg : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal aximm1_addr_reg_185 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln318_fu_145_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln318_reg_191 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal icmp_ln318_fu_151_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln318_reg_196 : STD_LOGIC_VECTOR (0 downto 0);
    signal aximm1_addr_read_reg_200 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state71 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state71 : signal is "none";
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state72 : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_phi_mux_i_phi_fu_109_p4 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_cast_i_fu_157_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln319_fu_162_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sext_ln319_fu_130_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal num_chunks_fu_70 : STD_LOGIC_VECTOR (7 downto 0);
    signal num_chunks_1_fu_167_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal ap_CS_fsm_state75 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state75 : signal is "none";
    signal trunc_ln319_1_fu_120_p4 : STD_LOGIC_VECTOR (62 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln318_reg_196 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                i_reg_105 <= add_ln318_reg_191;
            end if; 
        end if;
    end process;

    num_chunks_fu_70_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_length_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                num_chunks_fu_70 <= ap_const_lv8_0;
            elsif (((icmp_ln319_fu_162_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                num_chunks_fu_70 <= num_chunks_1_fu_167_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln318_reg_191 <= add_ln318_fu_145_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                aximm1_addr_read_reg_200 <= m_axi_aximm1_RDATA;
                i_reg_105_pp0_iter1_reg <= i_reg_105;
                icmp_ln318_reg_196 <= icmp_ln318_fu_151_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                aximm1_addr_reg_185 <= sext_ln319_fu_130_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, input_length_empty_n, m_axi_aximm1_ARREADY, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter0, icmp_ln318_fu_151_p2, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((icmp_ln318_fu_151_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)) or ((icmp_ln318_fu_151_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)))) then
    ...
    add_ln318_fu_145_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_phi_fu_109_p4) + unsigned(ap_const_lv3_1));
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_aximm1_RVALID, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_aximm1_RVALID = ap_const_logic_0));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_aximm1_RVALID, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_aximm1_RVALID = ap_const_logic_0));
    end process;


    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, input_length_empty_n)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_length_empty_n = ap_const_logic_0));
    end process;

        ap_block_state72_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state73_pp0_stage0_iter1_assign_proc : process(m_axi_aximm1_RVALID)
    begin
                ap_block_state73_pp0_stage0_iter1 <= (m_axi_aximm1_RVALID = ap_const_logic_0);
    end process;

        ap_block_state74_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state72_assign_proc : process(icmp_ln318_fu_151_p2)
    begin
        if ((icmp_ln318_fu_151_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_i_phi_fu_109_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, i_reg_105, add_ln318_reg_191, icmp_ln318_reg_196)
    begin
        if (((icmp_ln318_reg_196 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
            ap_phi_mux_i_phi_fu_109_p4 <= add_ln318_reg_191;
        else 
            ap_phi_mux_i_phi_fu_109_p4 <= i_reg_105;
        end if; 
    end process;
    ...
    aximm1_blk_n_R_assign_proc : process(m_axi_aximm1_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
    ...
    i_cast_i_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_105_pp0_iter1_reg),64));
    icmp_ln318_fu_151_p2 <= "1" when (ap_phi_mux_i_phi_fu_109_p4 = ap_const_lv3_4) else "0";
    icmp_ln319_fu_162_p2 <= "1" when (aximm1_addr_read_reg_200 = ap_const_lv16_0) else "0";

    input_length_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, input_length_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            input_length_blk_n <= input_length_empty_n;
        else 
            input_length_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    input_length_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, input_length_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (input_length_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            input_length_read <= ap_const_logic_1;
        else 
            input_length_read <= ap_const_logic_0;
        end if; 
    end process;

    input_length_temp_address0 <= i_cast_i_fu_157_p1(2 - 1 downto 0);

    input_length_temp_ce0_assign_proc : process(ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
    ...
    input_length_temp_d0 <= aximm1_addr_read_reg_200;

    input_length_temp_we0_assign_proc : process(ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2, icmp_ln319_fu_162_p2)
    begin
        if (((icmp_ln319_fu_162_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            input_length_temp_we0 <= ap_const_logic_1;
        else 
            input_length_temp_we0 <= ap_const_logic_0;
        end if; 
    end process;

    m_axi_aximm1_ARADDR <= aximm1_addr_reg_185;
    m_axi_aximm1_ARBURST <= ap_const_lv2_0;
    m_axi_aximm1_ARCACHE <= ap_const_lv4_0;
    m_axi_aximm1_ARID <= ap_const_lv1_0;
    m_axi_aximm1_ARLEN <= ap_const_lv32_4;
    ...
    m_axi_aximm1_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_aximm1_WDATA <= ap_const_lv16_0;
    m_axi_aximm1_WID <= ap_const_lv1_0;
    m_axi_aximm1_WLAST <= ap_const_logic_0;
    m_axi_aximm1_WSTRB <= ap_const_lv2_0;
    m_axi_aximm1_WUSER <= ap_const_lv1_0;
    m_axi_aximm1_WVALID <= ap_const_logic_0;
    num_chunks_1_fu_167_p2 <= std_logic_vector(unsigned(num_chunks_fu_70) + unsigned(ap_const_lv8_1));
        sext_ln319_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln319_1_fu_120_p4),64));

    trunc_ln319_1_fu_120_p4 <= input_length_dout(63 downto 1);
end behav;
