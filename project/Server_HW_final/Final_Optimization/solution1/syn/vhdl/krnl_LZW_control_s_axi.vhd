...
entity krnl_LZW_control_s_axi is
generic (
...
end entity krnl_LZW_control_s_axi;
...
architecture behave of krnl_LZW_control_s_axi is
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SEND_DATA_DATA_0) then
                    int_send_data(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_send_data(31 downto 0));
                end if;
            end if;
        end if;
    end process;
