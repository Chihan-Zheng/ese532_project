...
HLS_SOURCES = ../../../../baseline.cpp ../../../../common/check_endian.cpp ../../../../common/Utilities.cpp ../../../../LZW_hybrid_hash_HW.cpp ../../../../common/EventTimer.cpp ../../../../Dedup.cpp ../../../../Chunk.cpp
...
$(ObjDir)/baseline.o: ../../../../baseline.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../baseline.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/baseline.d

$(ObjDir)/check_endian.o: ../../../../common/check_endian.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../common/check_endian.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/check_endian.d
...
$(ObjDir)/EventTimer.o: ../../../../common/EventTimer.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../common/EventTimer.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/EventTimer.d
