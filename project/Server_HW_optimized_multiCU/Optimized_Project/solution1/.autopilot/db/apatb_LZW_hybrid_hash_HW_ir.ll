; ModuleID = '/mnt/castor/seas_home/c/chihan/chihan/ese532_project/project/Server_HW_optimized/Optimized_Project/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_LZW_hybrid_hash_HW_ir(i8* %in, i16* %input_length, i16* %send_data, i16* %output_length) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_LZW_hybrid_hash_HW_hw(i8* %in_copy, i16* %input_length_copy, i16* %send_data_copy, i16* %output_length_copy)
...
declare void @apatb_LZW_hybrid_hash_HW_hw(i8*, i16*, i16*, i16*)

define void @LZW_hybrid_hash_HW_hw_stub_wrapper(i8*, i16*, i16*, i16*) #5 {
entry:
  call void @copy_out(i8* null, i8* %0, i16* null, i16* %1, i16* null, i16* %2, i16* null, i16* %3)
  call void @LZW_hybrid_hash_HW_hw_stub(i8* %0, i16* %1, i16* %2, i16* %3)
  call void @copy_in(i8* null, i8* %0, i16* null, i16* %1, i16* null, i16* %2, i16* null, i16* %3)
  ret void
}

declare void @LZW_hybrid_hash_HW_hw_stub(i8*, i16*, i16*, i16*)
