...
// wrapc file define:
#define AUTOTB_TVIN_aximm1 "../tv/cdatafile/c.krnl_LZW.autotvin_aximm1.dat"
#define AUTOTB_TVOUT_aximm1 "../tv/cdatafile/c.krnl_LZW.autotvout_aximm1.dat"
// wrapc file define:
#define AUTOTB_TVIN_aximm2 "../tv/cdatafile/c.krnl_LZW.autotvin_aximm2.dat"
#define AUTOTB_TVOUT_aximm2 "../tv/cdatafile/c.krnl_LZW.autotvout_aximm2.dat"
// wrapc file define:
#define AUTOTB_TVIN_aximm3 "../tv/cdatafile/c.krnl_LZW.autotvin_aximm3.dat"
#define AUTOTB_TVOUT_aximm3 "../tv/cdatafile/c.krnl_LZW.autotvout_aximm3.dat"
// wrapc file define:
#define AUTOTB_TVIN_aximm4 "../tv/cdatafile/c.krnl_LZW.autotvin_aximm4.dat"
#define AUTOTB_TVOUT_aximm4 "../tv/cdatafile/c.krnl_LZW.autotvout_aximm4.dat"
// wrapc file define:
#define AUTOTB_TVIN_in "../tv/cdatafile/c.krnl_LZW.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in "../tv/cdatafile/c.krnl_LZW.autotvout_in_r.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_aximm1 "../tv/rtldatafile/rtl.krnl_LZW.autotvout_aximm1.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_aximm2 "../tv/rtldatafile/rtl.krnl_LZW.autotvout_aximm2.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_aximm3 "../tv/rtldatafile/rtl.krnl_LZW.autotvout_aximm3.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_aximm4 "../tv/rtldatafile/rtl.krnl_LZW.autotvout_aximm4.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_in "../tv/rtldatafile/rtl.krnl_LZW.autotvout_in_r.dat"
// tvout file define:
...
string get_depth_list () {
  ...
  total_list << "{aximm3 " << aximm3_depth << "}\n";
  total_list << "{aximm4 " << aximm4_depth << "}\n";
...
extern "C" void apatb_krnl_LZW_hw(volatile void * __xlx_apatb_param_in, volatile void * __xlx_apatb_param_input_length, volatile void * __xlx_apatb_param_send_data, volatile void * __xlx_apatb_param_output_length) {
  ...
  if (wrapc_switch_file_token.good())
  {
    ...
    string AESL_num;{
      ...
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_aximm3);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > aximm3_pc_buffer(1);
          int i = 0;

          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            RTLOutputCheckAndReplacement(AESL_token, "aximm3");
  
            // push token into output port buffer
            if (AESL_token != "") {
              aximm3_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (i > 0) {{
            ...
            ((int*)__xlx_apatb_param_send_data)[j] = aximm3_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_aximm4);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<16> > aximm4_pc_buffer(1);
          int i = 0;

          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            RTLOutputCheckAndReplacement(AESL_token, "aximm4");
  
            // push token into output port buffer
            if (AESL_token != "") {
              aximm4_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1; j < e; j += 1, ++i) {
            ((short*)__xlx_apatb_param_output_length)[j] = aximm4_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
//aximm3
aesl_fh.touch(AUTOTB_TVIN_aximm3);
aesl_fh.touch(AUTOTB_TVOUT_aximm3);
//aximm4
aesl_fh.touch(AUTOTB_TVIN_aximm4);
aesl_fh.touch(AUTOTB_TVOUT_aximm4);
//in
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_in)[j];
  ...
  tcl_file.set_num(1, &tcl_file.aximm1_depth);
...
// print aximm2 Transactions
{
  ...
  {  __xlx_offset_byte_param_input_length = 0*2;
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_input_length)[j];
  ...
  tcl_file.set_num(1, &tcl_file.aximm2_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_aximm2, __xlx_sprintf_buffer.data());
}
unsigned __xlx_offset_byte_param_send_data = 0;
// print aximm3 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_aximm3, __xlx_sprintf_buffer.data());
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_send_data)[j];
  ...
  tcl_file.set_num(1, &tcl_file.aximm3_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_aximm3, __xlx_sprintf_buffer.data());
}
unsigned __xlx_offset_byte_param_output_length = 0;
// print aximm4 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_aximm4, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_output_length = 0*2;
  if (__xlx_apatb_param_output_length) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_output_length)[j];
  ...
  tcl_file.set_num(1, &tcl_file.aximm4_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_aximm4, __xlx_sprintf_buffer.data());
}
...
krnl_LZW_hw_stub_wrapper(__xlx_apatb_param_in, __xlx_apatb_param_input_length, __xlx_apatb_param_send_data, __xlx_apatb_param_output_length);
CodeState = DUMP_OUTPUTS;
// print aximm3 Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVOUT_aximm3, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_send_data = 0*4;
  if (__xlx_apatb_param_send_data) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_send_data)[j];
...
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVOUT_aximm4, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_output_length = 0*2;
  if (__xlx_apatb_param_output_length) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_output_length)[j];
