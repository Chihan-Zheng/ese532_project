...
set id 15
set name krnl_LZW_mux_5129_72_1_1
...
set ID 18
set hasByteEnable 0
set MemName krnl_LZW_compute_LZW_store_array_i_i_i
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_aximm3 \
    op interface \
    ports { m_axi_aximm3_AWVALID { O 1 bit } m_axi_aximm3_AWREADY { I 1 bit } m_axi_aximm3_AWADDR { O 64 vector } m_axi_aximm3_AWID { O 1 vector } m_axi_aximm3_AWLEN { O 32 vector } m_axi_aximm3_AWSIZE { O 3 vector } m_axi_aximm3_AWBURST { O 2 vector } m_axi_aximm3_AWLOCK { O 2 vector } m_axi_aximm3_AWCACHE { O 4 vector } m_axi_aximm3_AWPROT { O 3 vector } m_axi_aximm3_AWQOS { O 4 vector } m_axi_aximm3_AWREGION { O 4 vector } m_axi_aximm3_AWUSER { O 1 vector } m_axi_aximm3_WVALID { O 1 bit } m_axi_aximm3_WREADY { I 1 bit } m_axi_aximm3_WDATA { O 32 vector } m_axi_aximm3_WSTRB { O 4 vector } m_axi_aximm3_WLAST { O 1 bit } m_axi_aximm3_WID { O 1 vector } m_axi_aximm3_WUSER { O 1 vector } m_axi_aximm3_ARVALID { O 1 bit } m_axi_aximm3_ARREADY { I 1 bit } m_axi_aximm3_ARADDR { O 64 vector } m_axi_aximm3_ARID { O 1 vector } m_axi_aximm3_ARLEN { O 32 vector } m_axi_aximm3_ARSIZE { O 3 vector } m_axi_aximm3_ARBURST { O 2 vector } m_axi_aximm3_ARLOCK { O 2 vector } m_axi_aximm3_ARCACHE { O 4 vector } m_axi_aximm3_ARPROT { O 3 vector } m_axi_aximm3_ARQOS { O 4 vector } m_axi_aximm3_ARREGION { O 4 vector } m_axi_aximm3_ARUSER { O 1 vector } m_axi_aximm3_RVALID { I 1 bit } m_axi_aximm3_RREADY { O 1 bit } m_axi_aximm3_RDATA { I 32 vector } m_axi_aximm3_RLAST { I 1 bit } m_axi_aximm3_RID { I 1 vector } m_axi_aximm3_RUSER { I 1 vector } m_axi_aximm3_RRESP { I 2 vector } m_axi_aximm3_BVALID { I 1 bit } m_axi_aximm3_BREADY { O 1 bit } m_axi_aximm3_BRESP { I 2 vector } m_axi_aximm3_BID { I 1 vector } m_axi_aximm3_BUSER { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_aximm4 \
    op interface \
    ports { m_axi_aximm4_AWVALID { O 1 bit } m_axi_aximm4_AWREADY { I 1 bit } m_axi_aximm4_AWADDR { O 64 vector } m_axi_aximm4_AWID { O 1 vector } m_axi_aximm4_AWLEN { O 32 vector } m_axi_aximm4_AWSIZE { O 3 vector } m_axi_aximm4_AWBURST { O 2 vector } m_axi_aximm4_AWLOCK { O 2 vector } m_axi_aximm4_AWCACHE { O 4 vector } m_axi_aximm4_AWPROT { O 3 vector } m_axi_aximm4_AWQOS { O 4 vector } m_axi_aximm4_AWREGION { O 4 vector } m_axi_aximm4_AWUSER { O 1 vector } m_axi_aximm4_WVALID { O 1 bit } m_axi_aximm4_WREADY { I 1 bit } m_axi_aximm4_WDATA { O 16 vector } m_axi_aximm4_WSTRB { O 2 vector } m_axi_aximm4_WLAST { O 1 bit } m_axi_aximm4_WID { O 1 vector } m_axi_aximm4_WUSER { O 1 vector } m_axi_aximm4_ARVALID { O 1 bit } m_axi_aximm4_ARREADY { I 1 bit } m_axi_aximm4_ARADDR { O 64 vector } m_axi_aximm4_ARID { O 1 vector } m_axi_aximm4_ARLEN { O 32 vector } m_axi_aximm4_ARSIZE { O 3 vector } m_axi_aximm4_ARBURST { O 2 vector } m_axi_aximm4_ARLOCK { O 2 vector } m_axi_aximm4_ARCACHE { O 4 vector } m_axi_aximm4_ARPROT { O 3 vector } m_axi_aximm4_ARQOS { O 4 vector } m_axi_aximm4_ARREGION { O 4 vector } m_axi_aximm4_ARUSER { O 1 vector } m_axi_aximm4_RVALID { I 1 bit } m_axi_aximm4_RREADY { O 1 bit } m_axi_aximm4_RDATA { I 16 vector } m_axi_aximm4_RLAST { I 1 bit } m_axi_aximm4_RID { I 1 vector } m_axi_aximm4_RUSER { I 1 vector } m_axi_aximm4_RRESP { I 2 vector } m_axi_aximm4_BVALID { I 1 bit } m_axi_aximm4_BREADY { O 1 bit } m_axi_aximm4_BRESP { I 2 vector } m_axi_aximm4_BID { I 1 vector } m_axi_aximm4_BUSER { I 1 vector } } \
} "
}
