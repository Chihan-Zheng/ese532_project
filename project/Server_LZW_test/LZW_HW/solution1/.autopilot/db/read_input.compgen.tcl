...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_in_len_V_loc \
    op interface \
    ports { in_len_V_loc_dout { I 13 vector } in_len_V_loc_empty_n { I 1 bit } in_len_V_loc_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 13 \
    name in_len_V_loc_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_in_len_V_loc_out \
    op interface \
    ports { in_len_V_loc_out_din { O 13 vector } in_len_V_loc_out_full_n { I 1 bit } in_len_V_loc_out_write { O 1 bit } } \
} "
}
