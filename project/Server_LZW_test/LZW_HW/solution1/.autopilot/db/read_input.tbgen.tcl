...
set C_modelArgList {
	...
	{ in_len_V_loc_out int 13 regular {fifo 1}  }
	{ inStream_in int 8 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "aximm1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_len_V_loc_out", "interface" : "fifo", "bitwidth" : 13, "direction" : "WRITEONLY"} , 
 	{ "Name" : "inStream_in", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ in_len_V_loc_out_din sc_out sc_lv 13 signal 3 } 
	{ in_len_V_loc_out_full_n sc_in sc_logic 1 signal 3 } 
	{ in_len_V_loc_out_write sc_out sc_logic 1 signal 3 } 
	{ inStream_in_din sc_out sc_lv 8 signal 4 } 
	{ inStream_in_full_n sc_in sc_logic 1 signal 4 } 
	{ inStream_in_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_len_V_loc_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "in_len_V_loc_out", "role": "din" }} , 
 	{ "name": "in_len_V_loc_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_len_V_loc_out", "role": "full_n" }} , 
 	{ "name": "in_len_V_loc_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_len_V_loc_out", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "in_len_V_loc_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "in_len_V_loc_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "inStream_in", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "65608"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "65608"}
]}
...
set Spec2ImplPortList { 
	...
	in_len_V_loc_out { ap_fifo {  { in_len_V_loc_out_din fifo_data 1 13 }  { in_len_V_loc_out_full_n fifo_status 0 1 }  { in_len_V_loc_out_write fifo_update 1 1 } } }
	inStream_in { ap_fifo {  { inStream_in_din fifo_data 1 8 }  { inStream_in_full_n fifo_status 0 1 }  { inStream_in_write fifo_update 1 1 } } }
}
