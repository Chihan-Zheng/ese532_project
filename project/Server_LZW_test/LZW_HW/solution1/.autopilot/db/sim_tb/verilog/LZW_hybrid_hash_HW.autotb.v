...
`define AUTOTB_DUT      LZW_hybrid_hash_HW
`define AUTOTB_DUT_INST AESL_inst_LZW_hybrid_hash_HW
`define AUTOTB_TOP      apatb_LZW_hybrid_hash_HW_top
`define AUTOTB_LAT_RESULT_FILE "LZW_hybrid_hash_HW.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "LZW_hybrid_hash_HW.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_LZW_hybrid_hash_HW_top
...
`define AESL_DEPTH_send_data 1
`define AESL_DEPTH_output_length 1
`define AUTOTB_TVIN_gmem  "./c.LZW_hybrid_hash_HW.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r  "./c.LZW_hybrid_hash_HW.autotvin_in_r.dat"
`define AUTOTB_TVIN_input_length  "./c.LZW_hybrid_hash_HW.autotvin_input_length.dat"
`define AUTOTB_TVIN_send_data  "./c.LZW_hybrid_hash_HW.autotvin_send_data.dat"
`define AUTOTB_TVIN_output_length  "./c.LZW_hybrid_hash_HW.autotvin_output_length.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.LZW_hybrid_hash_HW.autotvin_gmem.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "./rtl.LZW_hybrid_hash_HW.autotvin_in_r.dat"
`define AUTOTB_TVIN_input_length_out_wrapc  "./rtl.LZW_hybrid_hash_HW.autotvin_input_length.dat"
`define AUTOTB_TVIN_send_data_out_wrapc  "./rtl.LZW_hybrid_hash_HW.autotvin_send_data.dat"
`define AUTOTB_TVIN_output_length_out_wrapc  "./rtl.LZW_hybrid_hash_HW.autotvin_output_length.dat"
`define AUTOTB_TVOUT_gmem  "./c.LZW_hybrid_hash_HW.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.LZW_hybrid_hash_HW.autotvout_gmem.dat"
module `AUTOTB_TOP;
...
reg end_send_data;
reg [31:0] size_send_data;
reg [31:0] size_send_data_backup;
