...
module krnl_LZW_read_input (
        ...
        in_len_V_loc_read,
        in_len_V_loc_out_din,
        in_len_V_loc_out_full_n,
        in_len_V_loc_out_write,
        inStream_in_din,
        inStream_in_full_n,
        inStream_in_write
);
...
output  [7:0] m_axi_aximm1_WDATA;
output  [0:0] m_axi_aximm1_WSTRB;
...
output  [12:0] in_len_V_loc_out_din;
input   in_len_V_loc_out_full_n;
output   in_len_V_loc_out_write;
...
reg   [0:0] icmp_ln44_1_reg_170;
reg    in_r_blk_n;
reg    in_len_V_loc_blk_n;
reg    in_len_V_loc_out_blk_n;
reg    inStream_in_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln44_1_reg_170_pp0_iter1_reg;
reg   [12:0] i_reg_106;
reg   [12:0] in_len_V_loc_read_reg_144;
wire   [0:0] icmp_ln44_fu_117_p2;
reg   [63:0] aximm1_addr_reg_154;
wire   [12:0] add_ln44_fu_133_p2;
...
wire   [0:0] icmp_ln44_1_fu_139_p2;
reg   [7:0] aximm1_addr_read_reg_174;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        i_reg_106 <= 13'd0;
    end else if (((icmp_ln44_1_fu_139_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_reg_106 <= add_ln44_fu_133_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln44_1_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        aximm1_addr_read_reg_174 <= m_axi_aximm1_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln44_fu_117_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((icmp_ln44_1_fu_139_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln44_1_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln44_1_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln44_1_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        in_len_V_loc_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (in_len_V_loc_out_full_n == 1'b0) | (in_len_V_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        in_len_V_loc_out_write = 1'b1;
    end else begin
        in_len_V_loc_out_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln44_1_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (in_len_V_loc_out_full_n == 1'b0) | (in_len_V_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0)) & (icmp_ln44_fu_117_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (in_len_V_loc_out_full_n == 1'b0) | (in_len_V_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0)) & (icmp_ln44_fu_117_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln44_1_fu_139_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln44_1_fu_139_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
assign add_ln44_fu_133_p2 = (i_reg_106 + 13'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln44_1_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_in_full_n == 1'b0)) | ((icmp_ln44_1_reg_170 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln44_1_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_in_full_n == 1'b0)) | ((icmp_ln44_1_reg_170 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln44_1_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_in_full_n == 1'b0)) | ((icmp_ln44_1_reg_170 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (in_len_V_loc_out_full_n == 1'b0) | (in_len_V_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0));
end

assign ap_block_state72_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((icmp_ln44_1_reg_170 == 1'd0) & (m_axi_aximm1_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state74_pp0_stage0_iter2 = ((icmp_ln44_1_reg_170_pp0_iter1_reg == 1'd0) & (inStream_in_full_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign icmp_ln44_1_fu_139_p2 = ((i_reg_106 == in_len_V_loc_read_reg_144) ? 1'b1 : 1'b0);

assign icmp_ln44_fu_117_p2 = ((in_len_V_loc_dout == 13'd0) ? 1'b1 : 1'b0);

assign inStream_in_din = aximm1_addr_read_reg_174;

assign in_len_V_loc_out_din = in_len_V_loc_dout;

assign m_axi_aximm1_ARADDR = aximm1_addr_reg_154;
...
assign m_axi_aximm1_ARLEN = in_len_V_loc_read_reg_144;
...
assign m_axi_aximm1_WDATA = 8'd0;

assign m_axi_aximm1_WID = 1'd0;

assign m_axi_aximm1_WLAST = 1'b0;

assign m_axi_aximm1_WSTRB = 1'd0;
