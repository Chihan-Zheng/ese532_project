...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.LZW_hybrid_hash_HW.autotvin_gmem.dat"
         "c.LZW_hybrid_hash_HW.autotvin_in_r.dat"
         "c.LZW_hybrid_hash_HW.autotvin_input_length.dat"
         "c.LZW_hybrid_hash_HW.autotvin_send_data.dat"
         "c.LZW_hybrid_hash_HW.autotvin_output_length.dat"
         "c.LZW_hybrid_hash_HW.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.LZW_hybrid_hash_HW.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
