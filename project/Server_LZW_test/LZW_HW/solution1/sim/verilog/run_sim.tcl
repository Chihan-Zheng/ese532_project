...
if {[file isfile LZW_hybrid_hash_HW.autotvin.dat]} {
	file delete -force LZW_hybrid_hash_HW.autotvin.dat
}

if {[file isfile LZW_hybrid_hash_HW.autotvout.dat]} {
	file delete -force LZW_hybrid_hash_HW.autotvout.dat
}
