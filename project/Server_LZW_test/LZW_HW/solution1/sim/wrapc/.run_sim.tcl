...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LZW_hybrid_hash_HW.autotvin.dat"
	set constFileTvOut       "LZW_hybrid_hash_HW.autotvout.dat"
	set constFileHdlTvIn     "LZW_hybrid_hash_HW.autohdltvin.dat"
	set constFileHdlTvOut    "LZW_hybrid_hash_HW.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
