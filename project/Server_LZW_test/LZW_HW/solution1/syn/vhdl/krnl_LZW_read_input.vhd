...
attribute shreg_extract : string;
    ...
    signal icmp_ln44_1_reg_170 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_r_blk_n : STD_LOGIC;
    signal in_len_V_loc_blk_n : STD_LOGIC;
    signal in_len_V_loc_out_blk_n : STD_LOGIC;
    signal inStream_in_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal icmp_ln44_1_reg_170_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal i_reg_106 : STD_LOGIC_VECTOR (12 downto 0);
    signal in_len_V_loc_read_reg_144 : STD_LOGIC_VECTOR (12 downto 0);
    signal icmp_ln44_fu_117_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal aximm1_addr_reg_154 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln44_fu_133_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal icmp_ln44_1_fu_139_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal aximm1_addr_read_reg_174 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
                i_reg_106 <= ap_const_lv13_0;
            elsif (((icmp_ln44_1_fu_139_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_reg_106 <= add_ln44_fu_133_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln44_1_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                aximm1_addr_read_reg_174 <= m_axi_aximm1_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln44_fu_117_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                aximm1_addr_reg_154 <= in_r_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln44_1_reg_170 <= icmp_ln44_1_fu_139_p2;
                icmp_ln44_1_reg_170_pp0_iter1_reg <= icmp_ln44_1_reg_170;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                in_len_V_loc_read_reg_144 <= in_len_V_loc_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_aximm1_ARREADY, in_r_empty_n, in_len_V_loc_empty_n, in_len_V_loc_out_full_n, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln44_fu_117_p2, ap_enable_reg_pp0_iter0, icmp_ln44_1_fu_139_p2, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_len_V_loc_out_full_n = ap_const_logic_0) or (in_len_V_loc_empty_n = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0))) and (icmp_ln44_fu_117_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state75;
                elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_len_V_loc_out_full_n = ap_const_logic_0) or (in_len_V_loc_empty_n = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0))) and (icmp_ln44_fu_117_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    add_ln44_fu_133_p2 <= std_logic_vector(unsigned(i_reg_106) + unsigned(ap_const_lv13_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_aximm1_RVALID, inStream_in_full_n, ap_enable_reg_pp0_iter1, icmp_ln44_1_reg_170, ap_enable_reg_pp0_iter2, icmp_ln44_1_reg_170_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln44_1_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (inStream_in_full_n = ap_const_logic_0)) or ((icmp_ln44_1_reg_170 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_aximm1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_aximm1_RVALID, inStream_in_full_n, ap_enable_reg_pp0_iter1, icmp_ln44_1_reg_170, ap_enable_reg_pp0_iter2, icmp_ln44_1_reg_170_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln44_1_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (inStream_in_full_n = ap_const_logic_0)) or ((icmp_ln44_1_reg_170 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_aximm1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_aximm1_RVALID, inStream_in_full_n, ap_enable_reg_pp0_iter1, icmp_ln44_1_reg_170, ap_enable_reg_pp0_iter2, icmp_ln44_1_reg_170_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln44_1_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (inStream_in_full_n = ap_const_logic_0)) or ((icmp_ln44_1_reg_170 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_aximm1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, in_r_empty_n, in_len_V_loc_empty_n, in_len_V_loc_out_full_n)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_len_V_loc_out_full_n = ap_const_logic_0) or (in_len_V_loc_empty_n = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0));
    end process;

        ap_block_state72_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state73_pp0_stage0_iter1_assign_proc : process(m_axi_aximm1_RVALID, icmp_ln44_1_reg_170)
    begin
                ap_block_state73_pp0_stage0_iter1 <= ((icmp_ln44_1_reg_170 = ap_const_lv1_0) and (m_axi_aximm1_RVALID = ap_const_logic_0));
    end process;


    ap_block_state74_pp0_stage0_iter2_assign_proc : process(inStream_in_full_n, icmp_ln44_1_reg_170_pp0_iter1_reg)
    begin
                ap_block_state74_pp0_stage0_iter2 <= ((icmp_ln44_1_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (inStream_in_full_n = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state72_assign_proc : process(icmp_ln44_1_fu_139_p2)
    begin
        if ((icmp_ln44_1_fu_139_p2 = ap_const_lv1_1)) then 
    ...
    aximm1_blk_n_R_assign_proc : process(m_axi_aximm1_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln44_1_reg_170)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln44_1_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    icmp_ln44_1_fu_139_p2 <= "1" when (i_reg_106 = in_len_V_loc_read_reg_144) else "0";
    icmp_ln44_fu_117_p2 <= "1" when (in_len_V_loc_dout = ap_const_lv13_0) else "0";

    inStream_in_blk_n_assign_proc : process(inStream_in_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln44_1_reg_170_pp0_iter1_reg)
    begin
        if (((icmp_ln44_1_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    inStream_in_din <= aximm1_addr_read_reg_174;

    inStream_in_write_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln44_1_reg_170_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln44_1_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    in_len_V_loc_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, in_len_V_loc_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            in_len_V_loc_blk_n <= in_len_V_loc_empty_n;
        else 
            in_len_V_loc_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    in_len_V_loc_out_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, in_len_V_loc_out_full_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            in_len_V_loc_out_blk_n <= in_len_V_loc_out_full_n;
        else 
            in_len_V_loc_out_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    in_len_V_loc_out_din <= in_len_V_loc_dout;

    in_len_V_loc_out_write_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, in_r_empty_n, in_len_V_loc_empty_n, in_len_V_loc_out_full_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_len_V_loc_out_full_n = ap_const_logic_0) or (in_len_V_loc_empty_n = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            in_len_V_loc_out_write <= ap_const_logic_1;
        else 
            in_len_V_loc_out_write <= ap_const_logic_0;
        end if; 
    end process;


    in_len_V_loc_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, in_r_empty_n, in_len_V_loc_empty_n, in_len_V_loc_out_full_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_len_V_loc_out_full_n = ap_const_logic_0) or (in_len_V_loc_empty_n = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            in_len_V_loc_read <= ap_const_logic_1;
        else 
            in_len_V_loc_read <= ap_const_logic_0;
        end if; 
    end process;
    ...
    in_r_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, in_r_empty_n, in_len_V_loc_empty_n, in_len_V_loc_out_full_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_len_V_loc_out_full_n = ap_const_logic_0) or (in_len_V_loc_empty_n = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    m_axi_aximm1_ARADDR <= aximm1_addr_reg_154;
    m_axi_aximm1_ARBURST <= ap_const_lv2_0;
    m_axi_aximm1_ARCACHE <= ap_const_lv4_0;
    m_axi_aximm1_ARID <= ap_const_lv1_0;
    m_axi_aximm1_ARLEN <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_len_V_loc_read_reg_144),32));
    ...
    m_axi_aximm1_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln44_1_reg_170, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln44_1_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
